        ...
        <div class="col-lg-12">
            <div class="statbox widget box box-shadow">
                <div class="table-responsive mb-4 content">
                    ...
                    <h6>Matière: <strong>{{ $intero[0]['assign_subject']['school_subject']['name'] }}</strong> </h6>

                    <h6>Semestre: <strong>{{ $intero[0]['season']['name'] }}</strong> </h6>
                    <hr style="width: 50%">
                    ...
                    <form method="post"
                        action=" {{ route('marks.update', [$detail[0]->student_id, $intero[0]->assign_subject_id, $detail[0]->year_id, $intero[0]['season']['id']]) }}  ">
                        @csrf
                        ...
                        <div class="add_item_intero">
                            ...
                            <div class="" id="">
                                <div class="">
                                    ...
                                    <input type="hidden" name="season_id" value=" {{ $intero[0]['season']['id'] }} ">
                                    {{-- HIDDEN INPUT END --}}
                                    ...
                                    <table id="style-2" class="table exam-type style-2  ">
                                        ...
                                        <tbody>
                                            @if ($intero['0']['exam_type']['description'] == 'Intero')
                                                <h3 style="margin-top: 37px;">Intero</h3>
