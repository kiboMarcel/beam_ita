            ...
            <div class="statbox widget box box-shadow">
                ...
                <form method="post" action=" {{ route('employee.store') }} " enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-4 col-md-4">
                            <div class="form-group mb-4">
                                <label for="formGroupExampleInput">Genre <span class="text-danger">*</span></label>
                    ...
                    <div class="row">
                      ...
                      {{--   <div class="col-4 col-md-4">
                            <div class="form-group mb-4">
                                <label for="email">Nationalité <span class="text-danger">*</span></label>
                                <select name="nationality" id="select" class="custom-select" required>
                                    <option value="" disabled="">Sélectionner pays</option>
                        ...
                        <div class="col-4 col-md-4">
                            <div class="form-group mb-4">
                                <label for="formGroupExampleInput">Année de naissance <span class="text-danger">*</span></label>
                        ...
                        <div class="col-4 col-md-4">
                            <label for="text">Désignation <span class="text-danger">*</span></label>
                        ...
                        <div class="col-4 col-md-4">
                            <div class="form-group mb-4">
                                <label for="text">Début service <span class="text-danger">*</span></label>
                    ...
                    <div class="row">
                        ...
                        <div class="col-4 col-md-4">
                            <div class="form-group mb-4">
                                <label for="text">Contrat <span class="text-danger">*</span></label>
                        ...
                        <div class="col-4 col-md-4">
                            <div class="form-group mb-4">
                                <label for="text" id="salaire">Salaire <span class="text-danger">*</span></label>
