...
@section('admin')
    ...
    <script>
        ...
        function feetch(searchText, year_id){
            $.ajax({
                url: "{{ route('student.promotion.search') }}",
                type: "get",
                data: {'searchText':searchText, 'year_id':year_id,},
                beforeSend: function() {  
                    $("#loaderDiv").show();     
                }, 
                complete: function() {
