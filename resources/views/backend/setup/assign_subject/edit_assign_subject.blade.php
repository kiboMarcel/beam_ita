    ...
    <div class="row layout-top-spacing layout-spacing">
        <div class="col-lg-12">
            <div class="statbox widget box box-shadow">
                ...
                <form method="post"
                    action=" {{ route('assign.subject.update', [$editData[0]->class_id, $jsonId, $editData[0]->branch_id]) }}  ">
                    @csrf
                            ...
                            <div class="delete_whole_extra_item_add" id="delete_whole_extra_item_add">
                                <div class="row">
                                    ...
                                    <div class="col-3 col-md-3">
                                        <div class="form-group mb-4">
                                            <label for="email">Matières {{ $key + 1 }} <span
                                    ...
                                    <div class="col-2 col-md-2">
                                        <div class="form-group mb-4">
                                            ...
                                            <input type="text" name="full_mark[]" class="form-control"
                                                id="formGroupExampleInput" required value="{{ $edit->full_mark }} ">
                                            @error('amount')
                                    ...
                                    <div class="col-2 col-md-2">
                                        <div class="form-group mb-4">
                                            <label for="formGroupExampleInput">coefficient<span
                                                    class="text-danger">*</span></label>
                                            <input type="text" required name="subjective_mark[]" class="form-control"
                                                value="{{ $edit->coef }}">
                                            @error('amount')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                    ...
                                    <div class="col-2 col-md-2">
                                        ...
                                        <a id="delete" href=" {{ route('assign.subject.remove.single', $edit->id) }} ">
        ...
        <div class="whole_extra_item_add" id="whole_extra_item_add">
            <div class="delete_whole_extra_item_add" id="delete_whole_extra_item_add">
                <div class="form-row">
                    ...
                    <div class="col-3 col-md-3">
                        <div class="form-group mb-4">
                            <label for="formGroupExampleInput">Prof. <span class="text-danger">*</span></label>
