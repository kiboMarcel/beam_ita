                ...
                <div class="widget-content widget-content-area">
                    <div class="table-responsive mb-4">
                        <div class="head">
                            ...
                            <a href=" {{ route('subject.group.add') }} " class="btn btn-outline-secondary mb-2">Ajouter</a>
                        </div>
                                ...
                                @foreach ($allData as $key => $feeCat)
                                    <tr class="tr_style">
                                        ...
                                        <td class="text-center">
                                            <a href=" {{ route('subject.group.edit', $feeCat->id) }} " class="bs-tooltip"
                                      ...
                                      {{--   <td>
                                            <a href=" {{ route('subject.group.delete', $feeCat->id) }} " id="delete"
